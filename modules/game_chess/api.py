...
api_bp = Blueprint('game_chess_api', __name__, url_prefix='/api/chess')
...
def _get_room_detail(room):
    ...
    if room['status'] == 'playing' and game_state:
        detail['game_state'] = {
            ...
            'red_player': game_state.get('red_player'),
            'black_player': game_state.get('black_player'),
            'check_status': game_state.get('check_status'),
